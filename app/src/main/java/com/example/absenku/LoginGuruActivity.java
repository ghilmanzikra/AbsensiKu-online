...
public class LoginGuruActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Validate views
        if (etIdGuru == null || etPassword == null || btnLoginGuru == null) {
    ...
    private void attemptLogin() {
        if (validateInput()) {
            String username = etIdGuru.getText().toString().trim();
    ...
    private boolean validateInput() {
        ...
        // Reset error states
        etIdGuru.setError(null);
        etPassword.setError(null);

        if (username.isEmpty()) {
            etIdGuru.setError("Username tidak boleh kosong");
            etIdGuru.requestFocus();
            return false;
        }

        if (username.length() < 3) {
            etIdGuru.setError("Username minimal 3 karakter");
            etIdGuru.requestFocus();
            return false;
        }
    ...
    private void setLoadingState(boolean isLoading) {
        btnLoginGuru.setEnabled(!isLoading);
        btnLoginGuru.setText(isLoading ? "Logging in..." : "Login");
            ...
            try {
                ...
                if (result != null && result.success) {
                    ...
                    if (loginResponse != null && loginResponse.getUser() != null) {
                        ...
                        if ("guru".equals(loginResponse.getRole())) {
                            // Save session
                            ...
                            SweetAlertHelper.showLoginSuccess(LoginGuruActivity.this,
                                loginResponse.getUser().getUsername(),
                                () -> navigateToDashboard());
                        } else {
                            SweetAlertHelper.showWarning(LoginGuruActivity.this,
                                "Akses Ditolak",
                                "Akun ini bukan akun guru. Silakan gunakan login siswa.");
                        }
                    } else {
                        SweetAlertHelper.showError(LoginGuruActivity.this,
        ...
        try {
            ...
            call.enqueue(new Callback<LoginResponse>() {
                ...
                public void onFailure(Call<LoginResponse> call, Throwable t) {
                    ...
                    SweetAlertHelper.showNetworkError(LoginGuruActivity.this);
                }
            });
        } catch (Exception e) {
            setLoadingState(false);
    ...
    public void onBackPressed() {
        ...
        if (btnLoginGuru != null && !btnLoginGuru.isEnabled()) {
